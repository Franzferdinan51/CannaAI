...
const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    description: 'Send a single chat message to the CultivAI assistant (text-only). Returns the assistant reply plus provider metadata. Non-streaming variant of the chat endpoint.',
    inputSchema: {
      type: 'object',
      properties: {
