...
const AIProviderCard: React.FC = () => {
  ...
  const providers: Array<{
    ...
    },
    {
      id: 'grok',
      name: 'Grok (xAI OAuth)',
      description: 'Grok through your connected OpenClaw OAuth session',
      type: 'local',
      icon: <Brain className="w-5 h-5" />,
      color: 'purple',
      configPath: 'grok',
    ...
    },
    {
      id: 'openclaw',
      name: 'OpenClaw Agent',
      description: 'Use OpenClaw’s connected models, OAuth, and routing',
      type: 'local',
      icon: <Bot className="w-5 h-5" />,
      color: 'emerald',
      configPath: 'openclaw',
    ...
    },
    {
      id: 'hermes',
      name: 'Hermes Agent',
      description: 'Use Hermes’ connected provider and model routing',
      type: 'local',
      icon: <Brain className="w-5 h-5" />,
      color: 'orange',
      configPath: 'hermes',
                    ...
                    {provider.needsApiKey && (
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <button
                            type="button"
                            aria-label={`${showApiKey[provider.id] ? 'Hide' : 'Show'} ${provider.name} API key`}
                            onClick={(e) => {
                              e.stopPropagation();
                              setShowApiKey(prev => ({
                                ...prev,
